    ...
    <div class="content">
      <div class="text">
        ...
        <div class="hero-actions">
          ...
          <el-button style="border-color:#fff" color="transparent" size="large">开始倾述，获得陪伴</el-button>
        </div>
      </div>
      <div class="robot">
        <el-image :src="iconUrl" style="width: 150px;height: 150px;"class="robot-image"alt=机器人></el-image>
      </div>
    </div>
  </div>
</template>
