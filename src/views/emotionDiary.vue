    ...
    <div class="content">
      ...
      <div class="diary-card">
        ...
        <div class="emotion-grid">
          <div v-for="emotion in emotionOptions" :key="emotion.name" :class="{'selected':emotion.name==diaryForm.dominantEmotion}" class="emotion-card" @click="selectEmotion(emotion.name)">
      ...
      <div class="diary-card">
        ...
        <div class="detail-form">
          <div class="form-group">
            ...
            <el-input v-model="diaryForm.emotionTriggers" placeholder="今天什么事情影响了您的情绪" maxlength="1000" type="textarea" :rows="3" show-word-limit></el-input>
          </div>
          <div class="form-group">
            <div class="form-label">今日感想</div>
            <el-input v-model="diaryForm.diaryContent" placeholder="写下您今天的感想，感受或发生的有趣的事情..." maxlength="2000" type="textarea" :rows="6" show-word-limit></el-input>
          </div>
          <!-- 生活指标 -->
          ...
          <div class="action-buttons">
            ...
            <el-button type="primary" @click="sumbit(diaryForm)">提交</el-button>
          </div>
        </div>
      </div>
    </div>
